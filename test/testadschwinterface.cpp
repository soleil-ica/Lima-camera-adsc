...
{
public:
	TestFrameCallback(AdscHwInterface& simu_hw, HwBufferSave& buffer_save) 
		: m_adsc_hw(simu_hw), m_buffer_save(buffer_save) {}
protected:
	virtual bool newFrameReady(const HwFrameInfoType& frame_info);
private:
	AdscHwInterface& m_adsc_hw;
...
void print_status(AdscHwInterface& simu_hw)
{
	HwInterface::Status status;
