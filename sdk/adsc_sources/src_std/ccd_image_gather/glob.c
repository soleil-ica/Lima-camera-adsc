...
int	int_saturated = 65535;	/* value in integer array >= this is saturated 65535 is default unless overridden*/
...
char	rawfilename[1024];		/* output for raw file name */
...
char	jpeg1_name[1024];
char	jpeg2_name[1024];
char	jpeg1_size[32];
char	jpeg2_size[32];
