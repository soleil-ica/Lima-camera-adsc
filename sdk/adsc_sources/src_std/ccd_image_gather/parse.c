...
struct input_pair modifier_list[] =
{
	...
	JPEG1_NAME_MOD,		"jpeg1_name",
	JPEG1_SIZE_MOD,		"jpeg1_size",
	JPEG2_NAME_MOD,		"jpeg2_name",
	JPEG2_SIZE_MOD,		"jpeg2_size",
	SEQ_MOD,		"seq",
	-1,			NULL,
};
...
int	process_buffer()
{
	...
	if(0)
	  fprintf(stderr,"process_buffer, input:\n%s\n", inbuf);
	while(1)
	{
